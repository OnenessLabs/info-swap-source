      ...
      <BlockedWrapper>
        <BlockedMessageWrapper>
          <AutoColumn gap="1rem" justify="center">
            ...
            <Link external={true} href={'https://scan.devnet.onenesslabs.io/address/' + address}>{`More about ${shortenAddress(
              address
            )}`}</Link>
          </AutoColumn>
        </BlockedMessageWrapper>
        ...
        <RowBetween style={{ flexWrap: 'wrap', alingItems: 'start' }}>
          <AutoRow align="flex-end" style={{ width: 'fit-content' }}>
            ...
            <Link
              ...
              external
              href={'https://scan.devnet.onenesslabs.io/address/' + address}
            >
              ...
              >
                <TokenDetailsLayout>
                  ...
                  <ButtonLight color={backgroundColor}>
                    <Link color={backgroundColor} external href={'https://scan.devnet.onenesslabs.io/address/' + address}>
                      View on Oneness scan ↗
                    </Link>
                  </ButtonLight>
                </TokenDetailsLayout>
              </Panel>
