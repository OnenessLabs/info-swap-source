...
export const urls = {
  showTransaction: (tx) => `https://scan.devnet.onenesslabs.io/tx/${tx}/`,
  showAddress: (address) => `https://www.scan.devnet.onenesslabs.io/address/${address}/`,
  showToken: (address) => `https://www.scan.devnet.onenesslabs.io/token/${address}/`,
  showBlock: (block) => `https://scan.devnet.onenesslabs.io/block/${block}/`,
}
